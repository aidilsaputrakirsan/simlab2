...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    url: "#",
    icon: Key,
    roles: [userRole.Admin, userRole.Laboran, userRole.KepalaLabJurusan],
    items: [
      ...
      { title: "Praktikum", url: "/panel/praktikum", roles: [userRole.Admin, userRole.KepalaLabJurusan] },
      { title: "Modul Praktikum", url: "/panel/modul-praktikum", roles: [userRole.Admin, userRole.KepalaLabJurusan] },
