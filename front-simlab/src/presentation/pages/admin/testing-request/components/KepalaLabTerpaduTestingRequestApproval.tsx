...
const KepalaLabTerpaduTestingRequestApproval = () => {
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <Table
                            ...
                            columns={TestingRequestVerificationColumn({ openApproval: openKepalaLabApproval, openRejection })}
                            loading={isLoading}
...
export default KepalaLabTerpaduTestingRequestApproval