...
interface BookingRevisionDialogProps {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    handleRejection: (data: BookingVerifyDTO) => Promise<void>;
}

const BookingRevisionDialog: React.FC<BookingRevisionDialogProps> = ({ open, onOpenChange, handleRejection }) => {
...
export default BookingRevisionDialog;
