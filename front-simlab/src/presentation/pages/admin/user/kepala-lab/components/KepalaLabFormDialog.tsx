...
interface KepalaLabFormDialogProps {
    title: string,
    open: boolean,
...
const KepalaLabFormDialog: React.FC<KepalaLabFormDialogProps> = ({
    title,
    open,
    studyPrograms,
    data,
    ...
    useEffect(() => {
        ...
        if (dataId) {
            ...
            if (selectedKepalaLabTerpadu) {
                setFormData({
                    name: selectedKepalaLabTerpadu.name,
                    email: selectedKepalaLabTerpadu.email,
                    role: selectedKepalaLabTerpadu.role,
                    study_program_id: selectedKepalaLabTerpadu.studyProgram?.id ?? null,
                    identity_num: selectedKepalaLabTerpadu.identityNum,
                    password: ''
                })
            }
        } else {
...
export default KepalaLabFormDialog
