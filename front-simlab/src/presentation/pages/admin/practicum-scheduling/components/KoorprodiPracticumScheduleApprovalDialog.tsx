...
interface KoorprodiPracticumScheduleApprovalDialogProps {
    open: boolean,
    onOpenChange: (open: boolean) => void,
    handleSave: (data: PracticumSchedulingVerifyDTO) => Promise<void>
}

const KoorprodiPracticumScheduleApprovalDialog: React.FC<KoorprodiPracticumScheduleApprovalDialogProps> = ({ open, onOpenChange, handleSave }) => {
...
export default KoorprodiPracticumScheduleApprovalDialog